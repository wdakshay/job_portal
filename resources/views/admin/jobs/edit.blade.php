                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option {{ $job->status == 0 ? 'selected' : '' }} value=0>Inactive</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="" class="mb-2">Featured Job<span
                                                class="req">*</span></label>
                                        <select name="isFeatured" id="isFeatured" class="form-control">
                                            <option value="">Select Featured Job</option>
                                            <option {{ $job->isFeatured == 1 ? 'selected' : '' }} value=1>Featured</option>
                                            <option {{ $job->isFeatured == 0 ? 'selected' : '' }} value=0>Not Featured
                                            </option>
                                        </select>
                                    </div>
                                </div>
